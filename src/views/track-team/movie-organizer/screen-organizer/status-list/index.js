...
const Index = () => {
    ...
    const handlePagination = usePaginationHook(fetchScreenTrackRequestData);

    useEffect(() => {
        dispatch(fetchScreenTrackRequestData({
            ...DEFAULT_PAGE_SIZE,
            ...
            <Card>
                ...
                >
                    <SearchBarWithStatus
                        ...
                        fetchFunction={fetchScreenTrackRequestData}
                    />
                    <Space>
                        <Button
                            type="primary"
