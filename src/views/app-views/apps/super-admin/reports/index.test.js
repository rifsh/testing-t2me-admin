...
describe('SuperAdminReport Component', () => {
    ...
    describe('Component Rendering', () => {
        test('should render component without crashing', async () => {
            ...
            const element = await screen.findByText(/Event Organizers/i);
        ...
        test('should display statistics cards with correct data', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText('Active Event Organizers')).toBeInTheDocument();
                expect(screen.getByText('Total Events')).toBeInTheDocument();
                expect(screen.getByText('Events Revenue')).toBeInTheDocument();
            }, { timeout: 3000 });
        });
    ...
    describe('Tab Switching', () => {
        test('should switch to movies tab when clicked', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Movie Organizers')).toBeInTheDocument();
        ...
        test('should update statistics when switching tabs', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Movies Revenue')).toBeInTheDocument();
            }, { timeout: 3000 });
        });
    });
