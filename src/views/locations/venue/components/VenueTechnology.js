...
const VenueTechnology = ({ form }) => {
  useEffect(() => {
    ...
    form.setFieldsValue({
      screen_tech: currentValues.screen_tech?.length
        ? currentValues.screen_tech
        : [{ name: "", description: "" }],
      audios: currentValues.audios?.length
        ? currentValues.audios
        : [{ name: "", description: "" }],
      accessbility_feature: currentValues.accessbility_feature?.length
        ? currentValues.accessbility_feature
        : [{ name: "", description: "" }],
    });
  }, [form]);
    ...
    <>
      <Tabs defaultActiveKey="screen" className="w-full">
        <Tabs.TabPane
          tab={
            <span>
              <DesktopOutlined /> Screen Technology
            </span>
          }
          key="screen"
          forceRender
                    ...
                    <Col xs={24} md={10}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Enter screen technology",
                          },
                        ]}
                      >
        ...
        <Tabs.TabPane
          tab={
            <span>
              <SoundOutlined /> Audio Technology
            </span>
          }
          key="audio"
          forceRender
                  ...
                  >
                    <Col xs={24} md={10}>
                      <Form.Item
                        ...
                        name={[name, "name"]}
                        rules={[
                          { required: true, message: "Enter audio technology" },
                        ]}
                      >
        ...
        <Tabs.TabPane
          tab={
            <span>
              <SafetyOutlined /> Accessibility Features
            </span>
          }
          key="accessibility"
          forceRender
                    ...
                    <Col xs={24} md={10}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Enter accessibility feature",
                          },
                        ]}
                      >
