    ...
    return (
        <div style={{ padding: "24px" }}>
            <Row gutter={[24, 24]}>
                {/* Offers Section */}
                <Col xs={24} lg={12}>
                    <Title level={4} style={{ marginBottom: "16px", color: "#1890ff" }}>Special Offers</Title>
                                ...
                                <Col span={24} key={index}>
                                    ...
                                    >
                                        <Row gutter={[16, 16]} align="middle">
                                            ...
                                            <Col xs={24} md={16}>
                                                <Title level={4} style={{ color: "#389e0d", margin: "0 0 8px 0" }}>
                                                    {offer.offer.name}
                                                </Title>
                                                <div style={{
                                                    padding: "4px 12px",
                                                ...
                                                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", fontSize: "14px" }}>
                                                    <div style={{ color: "#666" }}>
                                                        <span style={{ fontWeight: "500", marginRight: "4px" }}>Max Uses:</span>
                                                        {offer.offer.max_uses}
                                                    </div>
                                                    <div style={{ color: "#666" }}>
                                                        <span style={{ fontWeight: "500", marginRight: "4px" }}>Valid:</span>
                ...
                {/* Coupons Section */}
                <Col xs={24} lg={12}>
                    <Title level={4} style={{ marginBottom: "16px", color: "#1890ff" }}>Event Coupons</Title>
                    {eventDetails?.event_coupons?.length > 0 ? (
                                ...
                                <Col span={24} key={index}>
                                    ...
                                    >
                                        <Row gutter={[16, 16]} align="middle">
                                            ...
                                            <Col xs={24} md={16}>
                                                <Title level={4} style={{ color: "#096dd9", margin: "0 0 8px 0" }}>
                                                    {coupon.coupons.name}
                                                </Title>
                                                <div style={{
                                                    padding: "4px 12px",
                        ...
                        <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="No special offers available" style={{ margin: "20px 0" }} />
                    )}
                </Col>
            </Row>
        </div>
