export const ApiConstant = {
  ...
  POTS_TERMS_AND_CONDITION: "/api/v1/shared/app_management/secured/terms_condition",
  ...
  TICKET_ASSIGN_DETAILS_URL: "/api/v1/shared/issue/secured/issues/assign/details",
  ...
  ADVERTISEMENT_BANNER_URL: "/api/v1/shared/banners/secured/advertisementbanner",
  ADVERTISEMENT_SCHEDULE_URL: "/api/v1/shared/banners/secured/advertisementschedule",
  ADVERTISEMENT_SCHEDULE_UPDATE_URL: "/api/v1/shared/banners/secured/adscheduleupdate",
  ...
  ADVERTISEMENT_CATEGORY_BANNER_URL: "/api/v1/shared/banners/secured/category_banners",
  ...
  EVENT_ORGANIZER_SINGLE_UPDATE: "/api/v1/event/events/secured/singleeventupdate",
  EVENT_ORGANIZER_SINGLE_UPDATE_PUT:
    "/api/v1/event/events/secured/superadminapproval",
  EVENT_ORGANIZER_EVENT_UPDATE: "/api/v1/event/events/secured/organizer_event_update",
  ...
  ADD_THEATER_COMPANY_URL: "/api/v1/movie/movies/secured/theatre_company/create",
  EDIT_THEATER_COMPANY_URL: "/api/v1/movie/movies/secured/theatre_company/edit",
  EDIT_THEATER_COMPANY_STATUS_URL: "/api/v1/movie/movies/secured/theatre_company/status",
  GET_THEATER_COMPANY_URL: "/api/v1/movie/movies/secured/theatre_company/all",
  GET_THEATER_COMPANY_BYID_URL: "/api/v1/movie/movies/secured/theatre_company/single",
  ...
  EDIT_PERSONALITY_STATUS_URL: "/api/v1/movie/movies/secured/personality/edit_status",
  ...
  SINGLE_CUSTOMER_LEAD_EVENT: "/api/v1/event/events/secured/single_customer_event",

  //seat api
  MOVIE_SEAT_URL: "/api/v1/movie/seats/secured/seatstructure",
  MOVIE_SEAT_EDIT_URL: "/api/v1/movie/seats/secured/seatstructure/edit",
  MOVIE_SEAT_STATUS_URL: "/api/v1/movie/seats/secured/seatstructure/edit/status",
